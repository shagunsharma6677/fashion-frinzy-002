...
export const getProduct = () => async (dispatch) => {
  try {
    ...
    let res = await axios
      .get("https://fashion-frenzy-be.onrender.com/admin")
      .then((res) => {
...
export const getProduct_user_details = () => async (dispatch) => {
  try {
    dispatch({ type: PRODUCT_DATA_LOADING });
    let res = await axios
      .get("https://fashion-frenzy-be.onrender.com/users")
      .then((res) => {
        dispatch({ type: PRODUCT_DATA_SUCCESS, payload: res.data });
...
export const postRequest = (payload) => (dispatch) => {
  ...
  axios
    .post("https://fashion-frenzy-be.onrender.com/admin/add", payload)
    .then((res) => {
...
export const deletedata = (_id) => (dispatch) => {
  dispatch(getpostRequest());
  return axios
    .delete(`https://fashion-frenzy-be.onrender.com/admin/delete/${_id}`)
    .then((res) => {
      // console.log(res.data);
...
export const editProduct = (_id, newData) => (dispatch) => {
  dispatch(getpostRequest());
  axios
    .patch(`https://fashion-frenzy-be.onrender.com/admin/update/${_id}`, newData)
    .then((res) => {
      console.log(res.data);
